...
while ($radek = mysqli_fetch_assoc($dotaz3)) {
   ...
   <div class='post clearfix'>
    <a href='prispevky/prispevek_premium.php?id=$prispevek'>
    <img src='.../$img' alt='$img' class='post-image'></a>
    <div class='post-preview'>
    <h2><a href='prispevky/prispevek_premium.php?id=$prispevek'>$nadpis</a> <span class='kategorie'>$kategorie</span><span class='kategorie' style='margin-left: 20px'>Premium</span> </h2>
    <i class='far fa-user'> $jmeno</i>
    <i class='far fa-clock'> $delka minut</i>
    ...
    <a href='prispevky/prispevek_premium.php?id=$prispevek' class='btn read-more'>Číst článek</a>
    </div>
    ...
    ";
        ...
        echo "
   <div class='post clearfix'>
    <a href='prispevky/prispevek.php?id=$prispevek'>
    <img src='.../$img' alt='$img' class='post-image'></a>
    <div class='post-preview'>
    <h2><a href='prispevky/prispevek.php?id=$prispevek'>$nadpis</a> <span class='kategorie'>$kategorie</span> </h2>
    <i class='far fa-user'> $jmeno</i>
    <i class='far fa-clock'> $delka minut </i>
    <i class='far fa-user'> $pocet $komentaru</i>
    &nbsp;
    ...
    <a href='prispevky/prispevek.php?id=$prispevek' class='btn read-more'>Číst článek</a>
    </div>
...
<!-- Sidebar Vedle Prispevku -->
    ...
    <div class="sidebar">
        ...
        <div class="section search">
            <h2 class="section-title">Vyhledávání</h2>
                ...
                <input type="text" name="search-term" class="hledej" id="hledac" placeholder="Vyhledávání příspěvků . . .">
                <p id="vypis"></p>
    ...
    ?>
            <ul>
                <?php echo "<li><a href='../PRJ-Blog/prispevky/filtr.php?filtr=$nzv'>• $nzv</a></li>"; ?>
            </ul>
    <?php }?>
...
<script>
    $(document).ready(function slova () {


        $("#hledac").keypress(function () {
            $.ajax({
                type: 'POST',
                url: 'server.php',
                data: {
